...
function HeroVisual({ reduce }: { reduce: boolean }) {
  // Simple sparkline path data for premium details
  const sparklines = [
  ...
  return (
    ...
    >
      ...
      >
        <motion.div
          className="relative overflow-hidden rounded-xl bg-linear-to-br from-[#0c0a21] via-[#141133] to-[#070514] p-6 border border-white/10"
        ...
        >
          ...
          <motion.div
            className="pointer-events-none absolute inset-x-0 top-0 h-[2px] bg-linear-to-r from-transparent via-violet-400 to-transparent opacity-80"
          ...
          {/* Premium Stats panel with Sparklines */}
          <motion.div
  ...
  return (
    <motion.div className="relative min-h-screen bg-white font-sans text-gray-900 antialiased">
      ...
      <motion.header
        ...
        className={`fixed inset-x-0 top-0 z-50 w-full transition-all duration-500 ${navSolid
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-3.5 sm:px-8 lg:px-10">
          <a href="#" className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              <span className="block text-lg font-extrabold tracking-tight text-gray-900">White-Label Solutions</span>
      ...
      <main className="overflow-x-clip pt-[4.75rem]">
        <section className="hc-hero-mesh relative overflow-hidden px-5 pb-8 pt-8 sm:px-8 sm:pb-12 sm:pt-10 lg:px-10 lg:pt-12">
          ...
          <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
            ...
            />
            <div className="absolute inset-0 bg-linear-to-b from-white/10 via-white/30 to-white/90" />
            <div className="hc-dot-grid absolute inset-0 opacity-40" aria-hidden />
            {/* Maxtron Logo overlay */}
            <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
              <MaxtronLogo size={120} className="opacity-8" />
            </div>
          </div>
        ...
        <section id="about" className="border-t border-violet-50 bg-violet-50/30 px-5 py-20 sm:px-8 sm:py-28 lg:px-10">
          <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-2 lg:gap-20">
            <Reveal>
              <div className="relative aspect-4/3 overflow-hidden rounded-3xl shadow-[var(--hc-shadow-lg)] border border-violet-100 bg-linear-to-br from-[#1e1b4b] via-violet-950 to-indigo-950">
                ...
                <div className="absolute inset-0 pt-10">
                  ...
                  />
                  <div className="absolute inset-0 bg-linear-to-t from-[#0f0c24] via-transparent to-[#0f0c24]/30 pointer-events-none" />
                </div>
